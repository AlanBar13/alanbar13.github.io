      ...
      <div className="main container">
        ...
        <table className="table">
          ...
          <tr style={{ textAlign: "start" }}>
            ...
            <td>
              <strong>
                Proyecto Centro de Apoyo al Desarrollo (CAD) en conjunto con la
                empresa LiCore
              </strong>
              <br /> Proyecto: Desarrollo de controladores (en el lenguaje VHDL)
              y elaboración de una tarjeta de adquisición de datos para tarjetas
              Xilinx
            </td>
          </tr>
        </table>
